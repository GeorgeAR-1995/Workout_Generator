...
switch (randomBodyPart) {
    case "chest":
      ...
      console.log(selectedChestExercises);
      break;
    ...
    case "legs":
      ...
      console.log(selectedLegExercises);
      break;
    ...
    case "back":
      ...
      console.log(selectedBackExercises);
      break;
    ...
    case "arms":
      ...
      console.log(selectedArmExercises);
      break;

    case "rest":
      //code
      console.log("Have a day off to recover.")
      break;
    ...
    case "stretch/cardio":
      ...
      console.log(selectedStretchCardioExercises);
      break;
